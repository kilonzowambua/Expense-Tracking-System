...
/* Update This SQL Add Store Session When Selling */
    ...
    $stmt->execute(); //ok
    $res = $stmt->get_result();
    while ($main = $res->fetch_object()) {

    $mail = new PHPMailer\PHPMailer\PHPMailer();
    $mail->setFrom($main->mailer_mail_from_email);
    $mail->addAddress($user_email);
    $mail->FromName = $main->mailer_mail_from_name;
    $mail->isHTML(true);
    $mail->IsSMTP();
    $mail->SMTPSecure = $main->mailer_protocol;
    $mail->Host = $main->mailer_host;
    $mail->SMTPAuth = true;
    $mail->Port = $main->mailer_port;
    $mail->Username = $main->mailer_username;
    $mail->Password = $main->mailer_password;
    $mail->Subject = 'Welcome to Expense Tracking System';
     /* Custom Mail Body */
     $mail->Body = '
    <!doctype html>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                              <tr>
                                <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                  ...
                                  <amp-img alt="Image" src="https://assets.unlayer.com/projects/135405/1675511641459-logo.png" width="328" height="162" layout="intrinsic" style="width: 32%;max-width: 32%;">
                      ...
                      <tbody>
                        <tr>
                          <td style="overflow-wrap:break-word;word-break:break-word;padding:0px 10px 31px;font-family:Cabin,sans-serif;" align="left">
                            ...
                            <div style="color: #e5eaf5; line-height: 140%; text-align: center; word-wrap: break-word;">
                              <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 28px; line-height: 39.2px;"><strong><span style="line-height: 39.2px; font-size: 28px;">WELCOME <br /></span></strong>
                                </span>
                              </p>
                            </div>
                        ...
                        <tr>
                          <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px;font-family:Cabin,sans-serif;" align="left">
                            ...
                            <div style="line-height: 160%; text-align: center; word-wrap: break-word;">
                              <p style="line-height: 160%;"><span style="font-size: 30px; line-height: 48px;">Welcome to the expense tracking party! Lets get started and find out where all your money goes</span></p>
                            </div>
                        ...
                        <tr>
                          <td style="overflow-wrap:break-word;word-break:break-word;padding:41px 55px 18px;font-family:Cabin,sans-serif;" align="left">
                            ...
                            <div style="color: #003399; line-height: 160%; text-align: center; word-wrap: break-word;">
                              ...
                              <p style="font-size: 14px; line-height: 160%;"><span style="font-size: 16px; line-height: 25.6px; color: #000000;">+100088<br /></span></p>
