...
<body class="crm_body_bg">
    ...
    if (mysqli_num_rows($user_sql) > 0) {
        while ($user = mysqli_fetch_array($user_sql)) {
            ...
            $user_current_salary=$user['user_current_salary'];
            global $user_names;
            
    ?>
    <?php if ($user_current_salary!='') { ?>
                                ...
                                <div class="white_box mb_30">
                                    <div class="box_header ">
                                        <div class="main-title">
                                            <h2 class="mb-0">Update Current Total Income</h2>
                                        </div>
                                    </div>
                                    <div class="card">
                                        ...
                                        <div class="card-body border border-primary">
                                            ...
                                            <form  method="post">
                                            <div class="mb-3">
                                                <label for="exampleFormControlInput1" class="form-label">Enter Total Income:</label>
                                                <input type="hidden" class="form-control" id="exampleFormControlInput1" name="user_id" value="<?php echo $user_id?>">
                                                <input type="number" required class="form-control" id="exampleFormControlInput1" name="user_current_salary" value="<?php echo $user_current_salary ?>">
                                            </div>
                                           

                                            <div class="d-flex mb-3 justify-content-md-center">
                                                <button type="submit"  class="btn btn-outline-primary" name="update_income">Update</button>
                                            </div>
                                            </form>
                                        </div>
                                    </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-12">
                                <div class="white_box mb_30">
                                    <div class="box_header ">
                                        <div class="main-title">
                                            <h2 class="mb-0">Add Current Total Income</h2>
                                        </div>
                                    </div>
                                    <div class="card">
                                        ...
                                        <div class="card-body border border-primary">
                                            ...
                                            <div class="d-flex mb-3 justify-content-md-center">
                                                <button type="submit"  class="btn btn-outline-primary" name="update_income">Add</button>
                                            </div>
                                            </form>
                                        </div>
                                    </div>
